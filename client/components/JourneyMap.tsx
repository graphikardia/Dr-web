...
const LogoKCRaju = ({ active }: { active: boolean }) => (
  <svg width="26" height="26" viewBox="0 0 26 26" fill="none">
    ...
    {/* Left wing */}
    <path
      d="M13 10 C10 9 8 11 9.5 13 C11 15 13 14 13 14"
      stroke={active ? "#86efac" : "#d1d5db"}
      strokeWidth="1.3"
      strokeLinecap="round"
      fill="none"
    />
    {/* Right wing */}
    <path
      d="M13 10 C16 9 18 11 16.5 13 C15 15 13 14 13 14"
      stroke={active ? "#86efac" : "#d1d5db"}
      strokeWidth="1.3"
      strokeLinecap="round"
      fill="none"
