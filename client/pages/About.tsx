...
const experienceStops = [
  {
    ...
    color: "#0055FF", bg: "#BCE5FF",
    icon: (
      <svg width="28" height="28" viewBox="0 0 40 40" fill="none">
        <path d="M21.048 13.33H31.79a2.733 2.733 0 012.733 2.733V33.39H18.314V16.063a2.733 2.733 0 012.734-2.733z" fill="white" stroke="#333" strokeWidth="1.2"/>
        <path d="M18.967 17.17H8.21a2.733 2.733 0 00-2.733 2.733V33.393h16.223V19.903a2.733 2.733 0 00-2.733-2.733z" fill="white" stroke="#333" strokeWidth="1.2"/>
        <path d="M26.291 6.607H13.314a2.733 2.733 0 00-2.733 2.733V33.392h18.444V9.34a2.733 2.733 0 00-2.734-2.733z" fill="white" stroke="#333" strokeWidth="1.2"/>
        <path d="M19.8 10.43v2.97M18.316 11.913h2.97" stroke="#333" strokeWidth="1.2" strokeLinecap="square"/>
        <rect x="15.3" y="16.57" width="1.333" height="1.333" fill="#333"/><rect x="19.133" y="16.57" width="1.333" height="1.333" fill="#333"/><rect x="22.967" y="16.57" width="1.333" height="1.333" fill="#333"/>
        <rect x="15.3" y="20.41" width="1.333" height="1.333" fill="#333"/><rect x="19.133" y="20.41" width="1.333" height="1.333" fill="#333"/><rect x="22.967" y="20.41" width="1.333" height="1.333" fill="#333"/>
        <rect x="15.3" y="24.25" width="1.333" height="1.333" fill="#333"/><rect x="19.133" y="24.25" width="1.333" height="1.333" fill="#333"/><rect x="22.967" y="24.25" width="1.333" height="1.333" fill="#333"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 40 40" fill="none">
        <path d="M30.618 20.449c3.091 1.234 5.19 4.145 5.387 7.468l.08 1.28c.057.975-.717 1.796-1.694 1.796H21.211c-.976 0-1.75-.821-1.693-1.796l.076-1.28c.197-3.323 2.296-6.233 5.387-7.467l2.819-1.126 2.818 1.125z" fill="white" stroke="#333" strokeWidth="1.2"/>
        <path d="M15.02 20.449c3.091 1.234 5.19 4.145 5.387 7.468l.076 1.28c.057.975-.717 1.796-1.693 1.796H5.613c-.976 0-1.75-.821-1.693-1.796l.076-1.28c.197-3.323 2.296-6.233 5.387-7.467l2.818-1.126 2.819 1.125z" fill="white" stroke="#333" strokeWidth="1.2"/>
        <ellipse cx="27.798" cy="16.834" rx="4.658" ry="4.658" fill="white" stroke="#333" strokeWidth="1.2"/>
        <ellipse cx="12.201" cy="16.834" rx="4.658" ry="4.658" fill="white" stroke="#333" strokeWidth="1.2"/>
        <path d="M24.47 18.594c3.091 1.234 5.19 4.145 5.387 7.468l.185 3.122c.057.974-.718 1.796-1.694 1.796H11.686c-.976 0-1.75-.822-1.693-1.796l.185-3.122c.197-3.323 2.296-6.234 5.387-7.468l4.453-1.778 4.453 1.778z" fill="white" stroke="#333" strokeWidth="1.2"/>
        <ellipse cx="20.016" cy="13.965" rx="5.557" ry="5.557" fill="white" stroke="#333" strokeWidth="1.2"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="24" height="30" viewBox="0 0 28 34" fill="none">
        <path d="M3.604.862H17.104a2.733 2.733 0 012.733 2.733v25.956H.871V3.595A2.733 2.733 0 013.604.862z" fill="white" stroke="#333" strokeWidth="1.2"/>
        <path d="M23.727 7.472l-5.852-.001V1.615" stroke="#333" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M6.48 12.512h12.472M6.48 17.164h12.472M6.48 21.776h5.152" stroke="#333" strokeWidth="1.2" strokeLinecap="round"/>
        <ellipse cx="20.983" cy="26.996" rx="6.743" ry="6.743" fill="white" stroke="#333" strokeWidth="1.2"/>
        <path d="M18.201 26.9l2.111 2.053 3.45-3.918" stroke="#333" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="28" height="28" viewBox="0 0 40 40" fill="none">
        <path d="M25.534 12.527c4.585 1.83 7.698 6.147 7.99 11.075l.198 3.372c.093 1.57-1.155 2.894-2.727 2.895H9.006c-1.573 0-2.82-1.325-2.728-2.895l.2-3.372c.29-4.928 3.403-9.244 7.989-11.07L20 10.317l5.534 2.21z" fill="white" stroke="#333" strokeWidth="1.2"/>
        <ellipse cx="20" cy="6.615" rx="7.5" ry="7.5" fill="white" stroke="#333" strokeWidth="1.2"/>
      </svg>
    ),
  },
];
...
function JourneyPath() {
  ...
  const pathD = "M 60 340 C 80 300 100 270 130 240 C 160 210 200 200 230 190 L 320 160 C 350 148 370 130 380 110 C 390 88 380 60 360 45 C 340 30 310 28 290 38 L 200 90 C 175 105 155 110 135 105 C 115 100 100 85 105 65 C 110 45 135 35 155 32 C 175 29 200 35 215 50";
  ...
  return (
    <div ref={sectionRef} className="relative w-full" style={{ minHeight: 440 }}>
      <svg viewBox="0 0 480 390" className="absolute inset-0 w-full h-full" style={{ maxHeight: 390 }} preserveAspectRatio="xMidYMid meet">
        <path d={pathD} stroke="#E5EBF2" strokeWidth="3" strokeDasharray="12 6" strokeLinecap="round" fill="none" />
        <path d={pathD} stroke="#BCE5FF" strokeWidth="3" strokeLinecap="round" fill="none"
        ...
        {iconPositions.map((pos, i) => (
          <g key={i}>
            {activeIdx >= i && (
              <circle cx={pos.x} cy={pos.y} r="22" fill={experienceStops[i].bg} opacity="0.6">
            ...
            {activeIdx >= i && <circle cx={pos.x} cy={pos.y - 22} r="4" fill={experienceStops[i].color} opacity="0.8"/>}
          </g>
        ))}
      </svg>
      {iconPositions.map((pos, i) => {
        ...
        return (
          <div key={i}
            ...
            style={{
              top: `calc(${pct.y}% - 30px)`,
              ...(isLeft ? { right: `calc(${100 - pct.x}% + 28px)` } : { left: `calc(${pct.x}% + 28px)` }),
              maxWidth: "42%",
            }}>
            <div className="flex-shrink-0 w-9 h-9 rounded-full flex items-center justify-center shadow-md border border-white" style={{ background: stop.bg }}>
              {stop.icon}
            </div>
            <div className={`bg-white rounded-xl shadow-lg border border-gray-100 p-3 transition-all duration-500 hover:shadow-xl hover:border-accent/40 ${active ? "scale-100" : "scale-95"}`}>
              <span className="text-xs font-bold px-2 py-0.5 rounded-full inline-block mb-1" style={{ background: stop.bg, color: stop.color }}>
                {stop.role}
              </span>
              <p className="text-xs font-bold text-primary leading-tight">{stop.hospital}</p>
              <p className="text-xs text-muted-foreground mt-0.5">{stop.location}</p>
            </div>
          </div>
        );
      })}
    ...
    <Layout>
      ...
      <section className="bg-gradient-to-br from-primary to-primary/85 text-primary-foreground py-14 md:py-20 relative overflow-hidden">
        ...
        <div className="container-max relative z-10">
          <h1 className="text-white mb-4 animate-slide-up">About Dr. Darshana Reddy</h1>
          <p className="text-lg text-primary-foreground/85 max-w-2xl animate-slide-up" style={{ animationDelay: "100ms" }}>
            FICP · MD · DNB · Senior Consultant, Internal Medicine & Diabetologist
          </p>
        </div>
      </section>
        ...
        <div className="container-max">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-14">
            {[
              ...
              <div key={idx} className="bg-gradient-to-br from-accent/10 to-accent/5 p-8 rounded-2xl border border-accent/20 hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-2 animate-slide-up text-center group"
                style={{ animationDelay: `${idx * 100}ms` }}>
                <div className="text-4xl mb-3">{item.icon}</div>
                <h3 className="text-3xl font-bold text-primary mb-2 group-hover:text-accent transition-colors">{item.value}</h3>
                <p className="text-muted-foreground font-medium">{item.label}</p>
              </div>
            ))}
          </div>
          <p className="text-lg text-muted-foreground leading-relaxed mb-6 animate-slide-up">
            Dr. Darshana Reddy is a distinguished physician with 16 years of progressive experience in internal medicine, commanding a reputation for clinical excellence and patient-centric care. Having treated over 2 lakh OPD patients — in addition to countless ICU and in-patient cases — she has become one of the most trusted healthcare providers in Bangalore.
          </p>
          <p className="text-lg text-muted-foreground leading-relaxed animate-slide-up" style={{ animationDelay: "100ms" }}>
            She holds the prestigious FICP (Fellow of Indian College of Physicians) designation, earned through demonstrated excellence in internal medicine. Dr. Reddy has worked at Bangalore's most respected institutions — from St. John's Medical College to Apollo Hospitals — bringing academic rigour and clinical expertise to every patient encounter.
          </p>
        </div>
      </section>

      {/* Work Experience — Journey Path */}
      <section className="section-padding bg-gradient-to-br from-slate-50 to-blue-50/40 relative overflow-hidden">
        ...
        <div className="container-max relative z-10">
          <div className="mb-10 animate-slide-up">
            <span className="inline-block bg-accent/10 text-accent px-4 py-1 rounded-full text-sm font-semibold mb-3">Career Journey</span>
      ...
      <section className="section-padding bg-white relative overflow-hidden">
        ...
        <div className="container-max relative z-10">
          <div className="mb-12 animate-slide-up">
            <span className="inline-block bg-accent/10 text-accent px-4 py-1 rounded-full text-sm font-semibold mb-3">Qualifications</span>
            <h2>Educational Background</h2>
          </div>
          <div className="max-w-3xl mx-auto">
            {education.map((edu, idx) => (
              <div key={idx} className="flex gap-6 mb-6 animate-slide-up" style={{ animationDelay: `${idx * 80}ms` }}>
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 bg-accent rounded-full flex items-center justify-center text-accent-foreground flex-shrink-0">
                    <GraduationCap size={22} />
                  </div>
                  {idx < education.length - 1 && <div className="w-0.5 h-16 bg-accent/30 mt-2" />}
                </div>
                <div className="pb-6 flex-1 group">
                  <div className="bg-gradient-to-br from-gray-50 to-accent/5 p-5 rounded-2xl hover:shadow-md hover:border-accent border-2 border-transparent transition-all duration-300">
                    <h3 className="text-base font-bold text-primary mb-1 group-hover:text-accent transition-colors">{edu.degree}</h3>
                    <p className="text-muted-foreground text-sm mb-2">{edu.institution}</p>
                    <span className="inline-block bg-accent/10 text-accent px-3 py-0.5 rounded-full text-xs font-semibold">{edu.year}</span>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="section-padding bg-gradient-to-br from-primary/5 to-accent/5 relative overflow-hidden">
        ...
        <div className="container-max relative z-10">
          <div className="text-center mb-12 animate-slide-up">
            <span className="inline-block bg-accent/10 text-accent px-4 py-1 rounded-full text-sm font-semibold mb-3">Media Coverage</span>
            <h2>Newspaper Articles</h2>
            <p className="text-muted-foreground mt-3 max-w-xl mx-auto">
              Regularly featured in Times of India, Bangalore Mirror, and Deccan Herald for expertise and community contributions.
            </p>
          </div>
          <NewspaperSlider />
        </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="mb-12 animate-slide-up">
            <span className="inline-block bg-accent/10 text-accent px-4 py-1 rounded-full text-sm font-semibold mb-3">Memberships</span>
            <h2>Professional Affiliations</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
            {affiliations.map((a, idx) => (
              <div key={idx} className="bg-gradient-to-br from-gray-50 to-accent/5 p-6 rounded-2xl shadow-sm hover:shadow-md hover:border-accent border-2 border-transparent transition-all duration-300 transform hover:scale-[1.02] animate-slide-up"
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-max">
          <div className="mb-12 animate-slide-up">
            <span className="inline-block bg-accent/10 text-accent px-4 py-1 rounded-full text-sm font-semibold mb-3">Giving Back</span>
            <h2>Community Service & Engagement</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {community.map((activity, idx) => (
              <div key={idx} className="flex gap-4 items-start p-6 bg-gradient-to-r from-accent/5 to-transparent rounded-2xl border border-accent/20 hover:shadow-md hover:border-accent transition-all duration-300 animate-slide-up group"
                style={{ animationDelay: `${idx * 100}ms` }}>
